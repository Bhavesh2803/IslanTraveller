...
public class Datum {
    ...
    @SerializedName("deal_created_at")
    @Expose
    private String dealCreatedAt;
    @SerializedName("deal_updated_at")
    @Expose
    private String dealUpdatedAt;
    ...
    public String getDealCreatedAt() {
        return dealCreatedAt;
    }

    public void setDealCreatedAt(String dealCreatedAt) {
        this.dealCreatedAt = dealCreatedAt;
    }

    public String getDealUpdatedAt() {
        return dealUpdatedAt;
    }

    public void setDealUpdatedAt(String dealUpdatedAt) {
        this.dealUpdatedAt = dealUpdatedAt;
    }
