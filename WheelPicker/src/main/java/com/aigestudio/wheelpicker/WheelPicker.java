...
public class WheelPicker extends View implements IDebug, IWheelPicker, Runnable {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        Log.v(TAG, canvas.getWidth() + ":" + canvas.getHeight());
        ...
        for (int drawnDataPos = drawnDataStartPos + mSelectedItemPosition,
            ...
            if (mSelectedItemTextColor != -1) {
                ...
                canvas.drawText(data, 210 + data.length() * 10, drawnCenterY, mPaint);
                mPaint.setColor(Color.parseColor(colors.get(color_index)));
                canvas.drawCircle(110, drawnCenterY - 20, 60, mPaint);
                canvas.restore();
                ...
                Log.v("Color","index : "+color_index +"text : "+data);
                canvas.restore();
            } else {
                canvas.save();
